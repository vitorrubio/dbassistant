...
The assistant endpoints are protected by a caller API key. Send the configured value in the header defined by `API_KEY_HEADER_NAME` when calling `POST /api/assistant/query`.
