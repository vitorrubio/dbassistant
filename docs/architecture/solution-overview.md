...
- `Services`: OpenAI integration and external service adapters.
...
3. The use case assembles schema context directly from live `INFORMATION_SCHEMA` metadata.
...
- [Technical Decisions](technical-decisions.md): rationale for cache, schema context strategy, deployment, secrets, and costs.
